...
function showMoreText(card) {
    ...
    let text = `Lorem ipsum dolor, sit amet consectetur adipisicing elit. Expedita corrupti cupiditate officiis quam porro quibusdam voluptatibus perspiciatis consectetur eligendi, in sunt, ut ducimus magni voluptatem, reiciendis quos accusamus atque voluptate?`;

    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    
    //  let obj = "<div class = 'desc'>" + text + "</div>";
    //  card.productName.insertAdjacentHTML("afterend", obj);
